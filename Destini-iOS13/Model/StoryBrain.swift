...
struct StoryBrain{
    ...
    mutating func setIndex(userChoice: String){
       let currentStory = listData[indexActive]
       if userChoice == currentStory.choice1 {
           indexActive = currentStory.choice1Destination
       } else if userChoice == currentStory.choice2 {
           indexActive = currentStory.choice2Destination
       }
